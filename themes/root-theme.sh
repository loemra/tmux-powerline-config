...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info 0 default" \
		"hostname $my_wine 255" \
		"pwd $my_purple 255" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"mailcount 9 255" \
		"now_playing $my_blue 255" \
		#"cpu 240 136" \
		# "load 237 167" \
		#"tmux_mem_cpu_load 234 136" \
		"battery $my_red 255" \
		"weather $my_green 255" \
		#"rainbarf 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}" \
		#"xkb_layout 125 117" \
		"date_day $my_dark 255" \
		"date $my_dark 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time $my_dark 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
