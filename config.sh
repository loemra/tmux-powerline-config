...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="root-theme"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/sw/ljh17lbj49g6lk45vz7n14t40000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/leomartins/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/leomartins/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="42.2808"
	TMUX_POWERLINE_SEG_WEATHER_LON="-83.7430"
# }
